...
<body class="bodyAdd">
    <form action="conditions.php" method="POST" id="formAddIntervention">
        <div>
            <label for="type_inter" class="form-label">Type d'intervention:</label>
            <select name="type_inter" id="selectTypeInter" class="form-control">
                <?php retrieveTache();?>
            </select>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" name="etage_inter" id="etage_inter" class="form-control">
        </div>
        <button type="submit" name="action" value="addingInter" class="btn btn-primary">Ajouter l'intervention</button>
    </form>
    <form action="conditions.php" method="POST" id="formAddTypeInter">
        <div>
    ...
    <a href="index.php" class="returnToIndex">Retour à la liste des interventions</a>
